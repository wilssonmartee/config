...
local theme                                     = {}
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/themes/matrix"
...
s.mytaglist = awful.widget.taglist(s, awful.widget.taglist.filter.noempty, awful.util.taglist_buttons, {font = "Font Awesome 9", bg_focus = theme.border_focus, fg_focus = theme.bg_normal})
